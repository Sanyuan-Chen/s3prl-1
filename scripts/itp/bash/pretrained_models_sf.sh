...
save_path=/datablob/users/v-sanych/s3prl_models/${model_name}_sf_bs${bs}_lr${lr}_acc${acc}
...
#  -n ${model_name}_sf_bs${bs}_lr${lr}_acc${acc}  \
#  -p ${save_path}  \
...
python3 run_downstream.py -m evaluate -e ${save_path}/valid-best.ckpt | tee ${save_path}/evaluate_results_submission.txt