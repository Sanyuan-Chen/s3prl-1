...
#save_path=/datablob/users/v-sanych/s3prl_models/hubert_pr_bs${bs}_lr1e${lr}_acc${acc}
#model_path=/datablob/users/v-sanych/pretrained_models/hubert_base_ls960.pt.fixed

save_path=/datablob/users/v-sanych/s3prl_models/hubert_large_pr_bs${bs}_lr1e${lr}_acc${acc}
...
#  -n hubert_pr_bs${bs}_lr1e${lr}_acc${acc}  \
#  -p ${save_path}  \
...
python3 run_downstream.py -m evaluate -e ${save_path}/dev-best.ckpt | tee ${save_path}/evaluate_results.txt